...
- [Cepher](https://github.com/flaviostutz/cepher) - A Docker Volume Plugin that enables you to store Docker volume data in Ceph clusters. Supports automatic image creation, filesystem formatting and removal. May use rbd-nbd, so the latest Ceph image features are available.
